export const productosPorLocal = {
  ...
  comida_rapida: [
    { nombre: 'Completo', precio: 2200, ingredientes: ['Vienesa', 'Tomate', 'Palta', 'Mayonesa'] },
    { nombre: 'Hamburguesa', precio: 3500, ingredientes: ['Pan', 'Carne', 'Queso', 'Lechuga', 'Tomate', 'Mayonesa'] },
    { nombre: 'Papas fritas', precio: 2000 },
    { nombre: 'Bebida', precio: 1200 },
    { nombre: 'Churrasco', precio: 4200, ingredientes: ['Pan', 'Carne', 'Tomate', 'Palta', 'Mayonesa'] },
    { nombre: 'Nuggets', precio: 2800, ingredientes: ['Nuggets', 'Salsa barbecue'] },
